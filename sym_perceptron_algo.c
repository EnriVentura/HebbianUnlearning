...
int main(int argc, char *argv[]){
	...
	sprintf(string, "sym_perceptron_overlap_N%d_alpha%Lg_lambda%Lg_maxstab%Lg_Nsamp%d.dat", N, alpha, lambda, c, N_samp);
	sprintf(string2, "sym_perceptron_Jmoments_N%d_alpha%Lg_lambda%Lg_maxstab%Lg_Nsamp%d.dat", N, alpha, lambda, c, N_samp);
	sprintf(string3, "sym_perceptron_stabilities_N%d_alpha%Lg_lambda%Lg_maxstab%Lg_Nsamp%d.dat", N, alpha, lambda, c, N_samp);
