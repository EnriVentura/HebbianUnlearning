...
int main(int argc, char *argv[])
{
	...
	int D, delta_D = (int)(0.005 / strenght), delta_D_histos = (int)(0.01 / strenght), D_max = (int)(D_maxstrenght / strenght);
	//delta_D_histos = (int)(0.05 / strenght) in v2.4
	...
	{
		sprintf(string, "unlearningV2NONORM_overlap_N%d_alpha%Lg_strenghtN%Lg_Nsamp%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
		sprintf(string2, "unlearningV2NONORM_Jmoments_N%d_alpha%Lg_strenghtN%Lg_Nsamp%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
		sprintf(string3, "unlearningV2NONORM_stabilities_N%d_alpha%Lg_strenghtN%Lg_Nsamp%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
		sprintf(string4, "unlearning_histoNONORM_SAT_N%d_alpha%Lg_strenghtN%Lg_Nsamp%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
		sprintf(string5, "unlearning_histoNONORM_UNSAT_N%d_alpha%Lg_strenghtN%Lg_Nsamp%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
		sprintf(string6, "unlearning_histoNONORM_ALL_N%d_alpha%Lg_strenghtN%Lg_Nsamp%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
		sprintf(string7, "unlearning_histoNONORM_MIN_N%d_alpha%Lg_strenghtN%Lg_Nsamp%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
		sprintf(string8, "unlearning_histoNONORM_MAX_N%d_alpha%Lg_strenghtN%Lg_Nsamp%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
	}
	else if (strcmp(NORM_TYPE, "ROW_NORM") == 0)
	{
		sprintf(string, "unlearningV2ROWNORM_overlap_N%d_alpha%Lg_strenghtN%Lg_seed%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
		sprintf(string2, "unlearningV2ROWNORM_Jmoments_N%d_alpha%Lg_strenghtN%Lg_seed%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
		sprintf(string3, "unlearningV2ROWNORM_stabilities_N%d_alpha%Lg_strenghtN%Lg_seed%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
		sprintf(string4, "unlearning_histoROWNORM_SAT_N%d_alpha%Lg_strenghtN%Lg_Nsamp%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
		sprintf(string5, "unlearning_histoROWNORM_UNSAT_N%d_alpha%Lg_strenghtN%Lg_Nsamp%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
		sprintf(string6, "unlearning_histoROWNORM_ALL_N%d_alpha%Lg_strenghtN%Lg_Nsamp%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
		sprintf(string7, "unlearning_histoROWNORM_MIN_N%d_alpha%Lg_strenghtN%Lg_Nsamp%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
		sprintf(string8, "unlearning_histoROWNORM_MAX_N%d_alpha%Lg_strenghtN%Lg_Nsamp%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
	}
	else if (strcmp(NORM_TYPE, "TOT_NORM") == 0)
	{
		sprintf(string, "unlearningV2TOT_NORM_overlap_N%d_alpha%Lg_strenghtN%Lg_seed%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
		sprintf(string2, "unlearningV2TOT_NORM_Jmoments_N%d_alpha%Lg_strenghtN%Lg_seed%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
		sprintf(string3, "unlearningV2TOT_NORM_stabilities_N%d_alpha%Lg_strenghtN%Lg_seed%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
		sprintf(string4, "unlearning_histoTOT_NORM_SAT_N%d_alpha%Lg_strenghtN%Lg_Nsamp%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
		sprintf(string5, "unlearning_histoTOT_NORM_UNSAT_N%d_alpha%Lg_strenghtN%Lg_Nsamp%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
		sprintf(string6, "unlearning_histoTOT_NORM_ALL_N%d_alpha%Lg_strenghtN%Lg_Nsamp%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
		sprintf(string7, "unlearning_histoTOT_NORM_MIN_N%d_alpha%Lg_strenghtN%Lg_Nsamp%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
		sprintf(string8, "unlearning_histoTOT_NORM_MAX_N%d_alpha%Lg_strenghtN%Lg_Nsamp%d_seed%d.dat", N, alpha, strenghtN, N_samp, seed);
	}
	else
	{
